...
export function SettlementTable({
  ...
  /** Row statuses from the reconciliation engine — omitted keeps the status cell honest (no invented PASS). */
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Rows — the shared read-only settlement display (one truth with /admin). */}
      <SettlementRowsTable rows={rows} statusByTransactionId={statusByTransactionId} />
    </div>
  );
}
