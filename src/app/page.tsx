...
const COMPANY_ID_P1 =
  'You create or operate in Music, Gaming & Interactive, Podcasting, Streaming, Social Media, Publishing, Movies & Film, TV & Video, Sports & Athletics, Fashion, Modeling & CAD, Visual Arts & Design, Books & Literature, Digital Assets & Software, VTubing & Virtual Avatars, or all of the above & more; Covnant is the autonomous clearinghouse built for your absolute independence with integrity. Your assets, identity, and equity remain uncompromised. This engine doesn\'t bend, break, fold, alter, or negotiate with outside pressure.';
const COMPANY_ID_P2 =
  'Existing industry pipelines force modern creators to navigate fragmented networks, opaque accounting, and delayed earnings. Covnant replaces that friction with a unified, high-performance, consolidated, institutional-grade multimedia contractual execution, distribution, and in-house clearing framework protocol.';
const COMPANY_ID_P3 =
  'By automating clearance across every sector and every nook & cranny within them, Covnant ensures that independent artists, IP owners, record labels, publishers, studios, production companies, retail stores, lounges, nightclubs, hotels, fashion houses, sports franchises, brands, Media & Immersive Tech, Storytelling & Gamified Platforms, Simulations & CAD Asset Stores, Professional Leagues & Governing Bodies, Broadcasters & Media Rights Holders, Talent & Management Agencies, venues, Arenas, Stadiums & Event Promoters, Arena operators, tournament organizers, motorsport circuits, etc. — all global enterprises — retain total authority over their assets, eliminate administrative bloat, and command immediate control over their cash flow. We honor execution over promises. Infrastructure isn\'t built on theory; it\'s forged through relentless precision, unbroken focus, and zero tolerance for inefficiency. We ensure your creation and assets are owned by you, hence our company motto: Own Your Creation!';
